...
MIDDLEWARE = [
    ...
    'config.middleware.AdminUzbekLocaleMiddleware',
...
STATICFILES_STORAGE = 'config.storage.NoSourceMapManifestStaticFilesStorage'
...
STORAGES = {
    ...
    'staticfiles': {
        'BACKEND': 'config.storage.NoSourceMapManifestStaticFilesStorage',
    },
}
